...
<div class="wm_button"><a href="../" target="_blank"><i class="icon-color-blue icon-no-border fa fa-facebook-square fa-3x"></i><br />Facebook</a></div>
...
<div class="wm_button"><a href="../" target="_blank"><i class="icon-color-light-green icon-no-border fa fa-bar-chart-o fa-3x"></i><br />Stats</a></div>
<div class="wm_button"><a href="../" target="_blank"><i class="icon-color-purple icon-no-border fa fa-envelope-o fa-3x"></i><br />Web Mail</a></div>
<div class="wm_button"><a href="http://forums.modx.com/" target="_blank"><i class="icon-color-orange icon-no-border fa fa-comments-o fa-3x"></i><br />Forum</a></div>